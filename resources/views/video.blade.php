    ...
    <body>
        <article>
            <header style="text-align: center;">
                <h1>
            <img src="/images/Hellotter-logo-icon.png" alt="" class="logimage" style="height: 150px;">
                </h1>
            ...
            <script>              
                ...
                (function() {
                    ...
                    if (uniqueToken)
                        if (location.hash.length > 2) uniqueToken.parentNode.parentNode.parentNode.innerHTML = '<h2 style="text-align:center;display: block;"><a href="' + location.href + '" target="_blank">Share with your Friend</a></h2>';
